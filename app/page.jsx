			...
			<div className='h-screen w-screen layer flex flex-col justify-center pt-4'>
				<div className='flex flex-col-reverse md:flex-row justify-center sm:justify-evenly items-center gap-4'>
					...
					<div className='flex flex-col basis-1/3 justify-center items-center p-4'>
						...
						>
							<div className='bg-neutral-900 shadow-2xl rounded-full w-56 h-56 z-10 sm:w-[18rem] sm:h-[18rem] md:w-[22rem] md:h-[22rem]'>
								<Image
									src={Spiderman}
									alt='Spiderman'
									height={1000}
									width={1000}
									className='w-64 h-64 z-20 rounded-full sm:w-[22rem} sm:h-[22rem} md:w-96 md:h-96'
								/>
							</div>
						</motion.div>
					</div>
